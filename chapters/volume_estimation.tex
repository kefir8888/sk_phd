...
Overall, random sample consensus is a standard way pf solving a number of computer vision problems, including perspective transform evaluation, 3D reconstruction\cite{nyalala2019tomato}, and pose estimation.
...
This method is widely used and developed, still receiving attention from the community, and it is modified in certain details, such as the method of measuring the distance from the model to the point \cite{han2023robust}.
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.8\textwidth]{images/tanj.jpg}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.8\textwidth]{images/jopa.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.8\textwidth]{images/train_loss.pdf}}
\caption{The dependence of the loss function on the training epoch.}
\label{fig_train_loss}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.8\textwidth]{images/rv_error.pdf}}
