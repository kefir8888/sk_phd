...
%\def\tableheadsize{\@setfontsize{\tableheadsize}{8}{9pt}}
%\def\tablesubheadsize{\@setfontsize{\tablesubheadsize}{7.56}{8pt}}
%\def\tablesize{\@setfontsize{\tablesize}{8.04}{12pt}}
...
\include{chapters/volume_estimation}
\include{chapters/disease_detection}
