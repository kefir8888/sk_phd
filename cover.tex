...
\title{A robot and a computer vision system for disease detection and crop yield estimation
...
\degree{Doctoral Program in Computational and Data Science and Engineering}
...
% once for each.
\supervisor{Pavel Osinenko}{Associate Professor}
