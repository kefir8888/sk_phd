...
\begin{enumerate}[leftmargin=18pt]
	...
	\item \textbf{Ilya Osokin}, Ryakin, Ilya and Yaremenko, Grigory and Moghimi, Sina and Davidenko, Sergei and Guneavoy, Vladimir and Patrikeev, Mikhail and Osinenko, Pavel, The Impact of Noise on the Quality of the Second-Order Curve Recognition by Random Sample Consensus Algorithm, Proceedings of the Zavalishinsky Readings, 2025, Saint-Petersburg, Russia;
	\item \textbf{Ilya Osokin}, Ryakin, Ilya and Moghimi, Sina and Davidenko, Sergei and Guneavoy, Vladimir and Yaremenko, Grigory and Osinenko, Pavel, Tangerine Volume Estimation by Point Cloud Data with Neural Networks, Proceedings of the EDM Conference, 2025, Chemal, Russia;
	\item Ilya Ryakin, \textbf{Ilya Osokin}, Moghimi, Sina and Davidenko, Sergei and Guneavoy, Vladimir and Yaremenko, Grigory and Osinenko, Pavel, Tangerine Volume Estimation by RANSAC on Point Cloud Data, Proceedings of the EDM Conference, 2025, Chemal, Russia;
	...
	\item Ilya Ryakin, \textbf{Ilya Osokin}, Osinenko, Pavel, Ellipsoidal objects volume estimation by combining detection with RANSAC, Proceedings of the MIPT Conference, 2025, Dolgoprudny, Russia;
\end{enumerate}
...
The \textbf{Propositions for Defense} are the following.
...
\textbf{The volume and structure of the work } is the following. 
The dissertation consists of ~an abstract, introduction,
\formbytotal{totalchapter}{chapter}{}{s}{},
conclusion, lists of abbreviations, figures and tables.
% and \formbytotal{totalappendix}{appendix}{}{es}{}.
